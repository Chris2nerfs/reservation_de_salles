<div class="container">
    <div class="row">
        <div class="col-1 order-1" style="border-bottom-color: black;">
        <br><br><br>
        &emsp;&ensp;<input type="radio" name="salle_id" id="salle_id" value="<?php echo $salle->getId(); ?>">
        </div>
        <div class="card col shadow border-info order-2">
            <div class="">
                <div class="card-body">
